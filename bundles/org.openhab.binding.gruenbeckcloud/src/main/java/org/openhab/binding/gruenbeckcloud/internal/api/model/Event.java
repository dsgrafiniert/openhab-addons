...
public class Event {
    ...
    /** 
        20:42:48.828 [DEBUG] [handler.GruenbeckCloudSoftenerHandler] - deviceStateChanged: org.openhab.binding.gruenbeckcloud.internal.api.model.Device@4fee14a2, Event 
...
*/
    ...
    public Event(String _message) {
        ...
        if (jsonObj.has("type")){
            ...
            if (type == 1){
                Type stringObjectMap = new TypeToken<ArrayList<Map<String, Object>>>(){}.getType();
